...
//               <Link to="/pets" className="nav-link">Pet Listing</Link>
...
//             <Link to="/pets" onClick={() => setIsMobileMenuOpen(false)}>Pet Listing</Link>
...
//                   <Link key={index} to="#" className="footer-social-link">
//                     <Icon size={20} />
//                   </Link>
//                 ))}
//               </div>
