      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Have questions about adoption? Need help finding the perfect pet? 
            We're here to help make your adoption journey smooth and successful.
          </p>
        </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button 
                ...
                className="w-full bg-orange-500 hover:bg-orange-600 disabled:bg-orange-300 text-white font-semibold py-3 px-6 rounded-md transition-colors duration-200 flex items-center justify-center"
              >
                {isSubmitting ? (
          ...
          <div className="space-y-8">
            ...
            <div className="bg-orange-50 rounded-lg p-6">
              ...
              <p className="text-gray-700 text-sm mb-4">
                Looking for answers to common questions? Check out our FAQ section first.
              </p>
              <Link
                to="/faq"
